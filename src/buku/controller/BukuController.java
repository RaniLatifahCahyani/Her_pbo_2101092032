...
public class BukuController {
    ...
    public void bersihForm(){
        formBuku.getTxtKode_buku().setText("");
        formBuku.getTxtJudul_buku().setText("");
    ...
    public void saveBuku(){
        buku = new Buku();
        buku.setKode_buku(formBuku.getTxtKode_buku().getText());
        buku.setJudul_buku(formBuku.getTxtJudul_buku().getText());
    ...
    public void getBuku(){
        ...
        if(buku!= null){
            formBuku.getTxtKode_buku().setText(buku.getKode_buku());
            formBuku.getTxtJudul_buku().setText(buku.getJudul_buku());
